...
common_args="${common_args} -DWANT_EXAMPLES=off -DWANT_TESTS=off -DWANT_DEMO=off -DWANT_ACODEC_DYNAMIC_LOAD=off -DFLAC_STATIC=on -DWANT_OPENAL=off -DWANT_NATIVE_IMAGE_LOADER=off -DWANT_IMAGE_FREEIMAGE=off"
